                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="user_name" class="form-control form-control" value="{{ $users->name }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Divisi</label>
                                                    <input type="hidden" name="" value="{{ $users->divisi->id }}">
                                                    <input type="text" name="" class="form-control" value="{{ $users->divisi->nama_divisi }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Mulai Kerja</label>
                                                    <input type="text" name="mulai_kerja" class="form-control" value="{{ $users->mulai_kerja }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Jumlah Pinjaman</label>
                                                    <input type="text" id="jumlah_pinjam" name="jumlah_pinjam" class="form-control" placeholder="Contoh : 1000000">
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Jangka Pelunasan (Berapa bulan)</label>
                                                    <input type="text" id="jangka_pelunasan" name="jangka_pelunasan" class="form-control" placeholder="Tuliskan angka saja ( Contoh: 2 )">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="largeInput">Jumlah Cicilan</label>
                                                    <input type="text" id="jumlah_cicilan" name="jumlah_cicilan" class="form-control" placeholder="Contoh : 500000">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="gaji" value="{{ $users->gaji }}" class="form-control " readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Keperluan</label>
                                                    <input type="text" name="keperluan" class="form-control" placeholder="Akan dipakai untuk apa">
                                                ...
                                                <div class="card-action">
                                                    <button id="alert_demo_3_3" class="btn btn-success w-100">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
