                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="largeInput">Judul Request Budget</label>
                                                    <input type="text" name="judul_request" class="form-control"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table table-hover table-striped table-bordered mt-5">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>
                                                            <input type="text" class="form-control" name="barang1"
                                                                required>
                                                        </td>
                                                        <td><input type="number" name="harga1"
                                                                class="form-control nilai-input" required></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>
                                                            <input type="text" class="form-control" name="barang2">
                                                        </td>
                                                        <td><input type="number" name="harga2"
                                                                class="form-control nilai-input"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td><input type="text" class="form-control" name="barang3">
                                                        </td>
                                                        <td><input type="number" name="harga3"
                                                                class="form-control nilai-input"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td>
                                                        <td><input type="text" class="form-control" name="barang4">
                                                        </td>
                                                        <td><input type="number" name="harga4"
                                                                class="form-control nilai-input"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>5</td>
