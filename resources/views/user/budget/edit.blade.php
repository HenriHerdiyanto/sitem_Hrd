                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="" class="form-control" value="{{ $users->divisi ? $users->divisi->nama_divisi : '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="modal-footer">
                                                    <a href="{{ route('user.budget.index') }}" type="button"
