                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admin.dinas.update', $perjalananDinas->id) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="card-body">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="largeInput">Diminta Oleh</label>
                                                    <input type="text" name="diminta_oleh"
                                                        value="{{ $perjalananDinas->diminta_oleh }}"
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Diketahui Oleh</label>
                                                    <input type="text" name="diketahui_oleh"
                                                        value="{{ $perjalananDinas->diketahui_oleh }}"
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="largeInput">Disetujui Oleh Oleh</label>
                                                    <input type="text" name="disetujui_oleh"
                                                        value="{{ $perjalananDinas->disetujui_oleh }}"
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="defaultSelect">Status Pengajuan</label>
                                                    <select class="form-control form-control" name="status">
                                                        <option value="{{ $perjalananDinas->status }}" selected>
                                                            {{ $perjalananDinas->status }}</option>
