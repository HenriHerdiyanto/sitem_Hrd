...
@section('content')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="hidden" class="form-control" id="user_id"
                                                    value="{{ $payroll->user_id }}" name="user_id" readonly>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $payroll->user->type }}" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label for="pendidikan" class="form-label">Pendidikan Terakhir</label>
                                                @if ($payroll->pendidikan == null)
                                                    <input type="text" class="form-control" id="pendidikan"
                                                        name="pendidikan" placeholder="Belum ada pendidikan" readonly>
                                                @else
                                                    <input type="text" class="form-control" id="pendidikan"
                                                        name="pendidikan" value="{{ $payroll->pendidikan }}" readonly>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $payroll->status_ptkp }}" name="status_ptkp" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">Cabang</label>
                                                <input type="text" class="form-control" value="{{ $payroll->cabang }}"
                                                    name="cabang" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">Group</label>
                                                <input type="text" class="form-control" value="{{ $payroll->group }}"
                                                    name="group" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="total2"
                                                    value="{{ $payroll->total_tunjangan }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <small style="color: red;">*Masukan Kembali Total Tunjangan Di
                                                    Luar Gaji Diatas</small>
                                                <input type="text" class="form-control"
                                                    value="{{ $payroll->total_tunjangan }}" name="total_tunjangan"
                                                    id="total_tunjangan" required>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="total_gaji_tunjangan"
                                                    id="total_gaji_tunjangan"
                                                    value="{{ $payroll->total_gaji_tunjangan }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="input3" value="0"
                                                    name="referal_client" value="{{ $payroll->referal_client }}" readonly
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="insentif_kk" class="form-label">INSENTIF KK-5%</label>
                                                <input type="text" class="form-control" name="insentif_kk"
                                                    id="input3" value="{{ $payroll->insentif_kk }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="insentif_spv" class="form-label">INSENTIF SPV-1%</label>
                                                <input type="text" class="form-control" name="insentif_spv"
                                                    id="input3" value="{{ $payroll->insentif_spv }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="insentif_staff" class="form-label">INSENTIF STAFF-2%</label>
                                                <input type="text" class="form-control" name="insentif_staff"
                                                    id="input3" value="{{ $payroll->insentif_staff }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="insentif_spt_op" class="form-label">INSENTIF SPT OP</label>
                                                <input type="text" class="form-control" name="insentif_spt_op"
                                                    id="input3" value="{{ $payroll->insentif_spt_op }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="insentif_spt_badan" class="form-label">INSENTIF SPT
                                                    BADAN</label>
                                                <input type="text" class="form-control" name="insentif_spt_badan"
                                                    id="input3" value="{{ $payroll->insentif_spt_badan }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="insentif_spt" class="form-label">INSENTIF SPT</label>
                                                <input type="text" class="form-control" name="insentif_spt"
                                                    id="input3" value="{{ $payroll->insentif_spt }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="komisi_marketing" class="form-label">KOMISI MARKETING</label>
                                                <input type="text" class="form-control" name="komisi_marketing"
                                                    id="input3" value="{{ $payroll->komisi_marketing }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">TOTAL INSENTIF DAN KOMISI
                                                    LAINNYA - PAYMENT PERTENGAHAN BULAN</label>
                                                <input type="text" class="form-control" id="total3"
                                                    value="{{ $payroll->total_insentif }}" readonly required>
                                            </div>
                                            <div class="mb-3">
                                                <small style="color: red;">*Masukan Kembali TOTAL INSENTIF DAN KOMISI
                                                    LAINNYA - PAYMENT PERTENGAHAN BULAN diatas</small>
                                                <input type="text" class="form-control" name="total_insentif"
                                                    id="total_insentif" value="{{ $payroll->total_insentif }}" required>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="total_pendapatan"
                                                    id="total_pendapatan" value="{{ $payroll->total_pendapatan }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="potonganpph21" class="form-label">Potongan PPH 21</label>
                                                <input type="text" class="form-control nilai-input4"
                                                    value="{{ $payroll->potonganpph21 }}" name="potonganpph21" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="terlambat" class="form-label">Terlambat</label>
                                                <input type="text" class="form-control nilai-input4"
                                                    value="{{ $payroll->terlambat }}" name="terlambat" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="cuti_bersama" class="form-label">Cuti Bersama</label>
                                                <input type="text" class="form-control nilai-input4"
                                                    name="cuti_bersama" value="{{ $payroll->cuti_bersama }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="cuti" class="form-label">Potongan CUTI</label>
                                                <input type="text" class="form-control nilai-input4" id="cuti"
                                                    name="cuti" value="{{ $payroll->cuti }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="izin" class="form-label">IZIN</label>
                                                <input type="text" class="form-control nilai-input4" name="izin"
                                                    value="{{ $payroll->izin }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="sakit" class="form-label">SAKIT</label>
                                                <input type="text" class="form-control nilai-input4" name="sakit"
                                                    id="potongan_sakit" value="{{ $payroll->sakit }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="alpha" class="form-label">Potongan Alpha</label>
                                                <input type="text" class="form-control nilai-input4" id="alpha"
                                                    name="alpha" value="{{ $payroll->alpha }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="pinjaman" class="form-label">Pinjaman</label>
                                                <input type="text" class="form-control nilai-input4" name="pinjaman"
                                                    value="{{ $payroll->pinjaman }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="bpjs_karyawan" class="form-label">BPJS KESEHATAN Ditanggung
                                                    Karyawan 1%</label>
                                                <input type="text" class="form-control nilai-input4"
                                                    name="bpjs_karyawan" value="{{ $payroll->bpjs_karyawan }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="ditanggung_karyawan" class="form-label">BPJS KETENAGAKERJAAN
                                                    Ditanggung Karyawan 2.00%</label>
                                                <input type="text" class="form-control nilai-input4"
                                                    name="ditanggung_karyawan"
                                                    value="{{ $payroll->ditanggung_karyawan }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="total_pengurangan" class="form-label">TOTAL
                                                    PENGURANGAN</label>
                                                <input type="text" class="form-control total-nilai4"
                                                    name="total_pengurangan" value="{{ $payroll->total_pengurangan }}"
                                                    readonly required>
                                            </div>
                                            <div class="mb-3">
                                                <small style="color: red;">
                                                    *Masukan TOTAL PENGURANGAN diatas</small>
                                                <input type="text" value="{{ $payroll->total_pengurangan }}"
                                                    class="form-control" id="total_pengurangan" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="jkk" id="jkk"
                                                    value="{{ $payroll->jkk }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="jkm" class="form-label">JKM 0.30%</label>
                                                <input type="text" class="form-control" name="jkm" id="jkm"
                                                    value="{{ $payroll->jkm }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="jht_37" class="form-label">JHT 3.7%</label>
                                                <input type="text" class="form-control" name="jht_37" id="jht_37"
                                                    value="{{ $payroll->jht_37 }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="ditanggung_perusahaan" class="form-label">BPJS KESEHATAN
                                                    Ditanggung Perusahaan 4%</label>
                                                <input type="text" class="form-control" name="ditanggung_perusahaan"
                                                    id="ditanggung_perusahaan"
                                                    value="{{ $payroll->ditanggung_perusahaan }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="bpjs_perusahaan" class="form-label">BPJS KETENAGAKERJAAN
                                                    Ditanggung Perusahaan 4.24%</label>
                                                <input type="text" class="form-control" name="bpjs_perusahaan"
                                                    id="bpjs_perusahaan" value="{{ $payroll->bpjs_perusahaan }}"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="total_gaji_bersih"
                                                    id="total_gaji_bersih" value="{{ $payroll->total_gaji_bersih }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="car-footer d-flex justify-content-end">
                                    <div class="m-4">
                                        <button type="submit" id="alert_demo_3_5"
                                            class="btn btn-lg btn-success">UPTADE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function hitungAlpha() {
            var totalGaji = parseFloat(document.getElementById("total_gaji").value);
            var jumlahAlpha = parseFloat(document.getElementById("jumlah_alpha").value);
    ...
    <script>
        ...
        // Memanggil fungsi hitungTotalNilai saat halaman dimuat
        window.addEventListener('load', hitungTotalNilai);
    </script>
