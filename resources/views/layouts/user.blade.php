            ...
            <div class="sidebar-wrapper scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item{{ $activePage === 'absen' ? ' active' : '' }}">
                        ...
                        <li class="nav-item{{ $activePage === 'budget' ? ' active' : '' }}">
                            <a href="{{ route('user.budget.index') }}">
                                <i class="fas fa-dollar-sign"></i>
                                <p>Permintaan Barang/Jasa</p>
                            </a>
                        </li>
                        <li class="nav-item{{ $activePage === 'pinjaman' ? ' active' : '' }}">
                            <a href="{{ route('user.pinjam.index') }}">
                                <i class="fas fa-money-bill-wave"></i>
                                <p>Pinjaman Karyawan</p>
                            </a>
                        </li>
                        <li class="nav-item{{ $activePage === 'lembur' ? ' active' : '' }}">
                            <a href="{{ route('user.lembur.index') }}">
                                <i class="fas fa-clock"></i>
                                <p>Lembur Karyawan</p>
                            </a>
                        </li>
                        <li class="nav-item{{ $activePage === 'reimbursement' ? ' active' : '' }}">
                            <a href="{{ route('user.reimbursements.index') }}">
