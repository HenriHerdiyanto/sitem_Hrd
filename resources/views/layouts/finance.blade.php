                ...
                <div class="sidebar-content">
                    <div class="user">
                        <div class="avatar-sm float-left mr-2">
                            <img src="{{ asset('assets/img/logomt.png') }}" alt="..." class="avatar-img rounded-circle">
                        </div>
                        <div class="info">
                            <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                                <span>
                                    ...
                                    <span class="user-level">Finance Account</span>
                                    {{-- <span class="user-level">{{ $user->type }}</span> --}}
                                ...
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="{{ route('absen.index') }}">
                                            <span class="sub-item">Absen Saya</span>
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="{{ route('reimbursements.index') }}">
                                            <span class="sub-item">reimbursement </span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
